...
func NewHuaWeiObsClient() (client *obs.ObsClient, err error) {
	return obs.New(global.MALL_CONFIG.HuaWeiObs.AccessKey, global.MALL_CONFIG.HuaWeiObs.SecretKey, global.MALL_CONFIG.HuaWeiObs.Endpoint)
}
...
func (o *Obs) UploadFile(file *multipart.FileHeader) (string, string, error) {
	...
	input := &obs.PutObjectInput{
		PutObjectBasicInput: obs.PutObjectBasicInput{
			ObjectOperationInput: obs.ObjectOperationInput{
				Bucket: global.MALL_CONFIG.HuaWeiObs.Bucket,
				Key:    filename,
			},
	...
	filepath := global.MALL_CONFIG.HuaWeiObs.Path + "/" + filename
