...
type GeneralDB struct {
	...
	ConnMaxLifetime int    `mapstructure:"conn-max-lifetime" json:"conn-max-lifetime" yaml:"conn-max-lifetime"`    // 可复用连接的最大时间长度(秒)
	ConnMaxIdleTime int    `mapstructure:"conn-max-idle-time" json:"conn-max-idle-time" yaml:"conn-max-idle-time"` // 连接在连接池中的最大空闲时间(秒)
